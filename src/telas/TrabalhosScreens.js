...
const styles = StyleSheet.create({
  ...
  cardTitulo: { fontSize: 16, fontWeight: 'bold', color: '#1E293B', marginBottom: 4 },
  cardData: { fontSize: 13, color: '#64748B', marginBottom: 6 },
  ...
  acoes: { flexDirection: 'column', alignItems: 'center' },
  icone: { padding: 4, marginVertical: 2 },
  ...
  labelSituacao: { fontSize: 13, color: '#475569', fontWeight: '600', marginBottom: 8, marginTop: 4 },
  situacaoRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  situacaoBotao: { borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderColor: '#CBD5E1' },
  situacaoTexto: { color: '#475569', fontWeight: '600', textTransform: 'capitalize' },
