...
const styles = StyleSheet.create({
  ...
  barraContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
  barraLabel: { width: 80, fontSize: 13, color: '#475569', fontWeight: '600', textTransform: 'capitalize' },
  barraTrilho: { flex: 1, height: 16, backgroundColor: '#E2E8F0', borderRadius: 8, overflow: 'hidden' },
  ...
  atividadePonto: { width: 12, height: 12, borderRadius: 6, marginRight: 12 },
  atividadeDesc: { fontSize: 14, fontWeight: '600', color: '#1E293B' },
  atividadeInfo: { fontSize: 12, color: '#64748B', marginTop: 2 },
  atividadeStatus: { fontSize: 12, fontWeight: 'bold', textTransform: 'capitalize' },
});